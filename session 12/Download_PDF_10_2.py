...
def chrome_setup():
    ...
    preferences = {"download.default_directory":location,"plugin.always_open_pdf_externally":True}
...
def Firefox_setup():
    ...
    ops.set_preference("browser.helperApps.neverAsk.saveToDisk","application/pdf") #value is mimetype
